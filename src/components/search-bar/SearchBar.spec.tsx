...
describe('Tests for the Search componen', () => {
  ...
  it('Verify that clicking the Search button with the mouse saves the entered value to the local storage', () => {
  ...
  it('Verify that clicking the Search button with the Enter saves the entered value to the local storage', () => {
    const { getByTestId } = render(
      <BrowserRouter>
        <SearchBar />
      </BrowserRouter>
    ...
    fireEvent.keyDown(getByTestId('test-btn'), {
      key: 'Enter',
      code: 'Enter',
      charCode: 13,
    });
